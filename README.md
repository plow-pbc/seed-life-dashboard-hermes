...
The umbrella collects two operator inputs once at install time (tier-3 prompts; never echoed; persisted only in the mode-600 inputs file `~/.config/seed/seed-life-dashboard-hermes.env`, outside the repo):
